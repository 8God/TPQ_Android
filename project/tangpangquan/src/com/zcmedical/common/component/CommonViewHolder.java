...
public class CommonViewHolder {
    ...
    public void setImageView(int imageViewId, String imageUri, int defaultImage, boolean isOpenLoadAnimation, IImageOnLoadingCompleteListener iImageOnLoadingCompleteListener) {
        ImageView imageView = getView(imageViewId);
        setImageView(imageView, imageUri, defaultImage, isOpenLoadAnimation, iImageOnLoadingCompleteListener);
    }

    public void setImageView(ImageView imageView, String imageUri, int defaultImage, boolean isOpenLoadAnimation, IImageOnLoadingCompleteListener iImageOnLoadingCompleteListener) {
