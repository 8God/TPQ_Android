...
public class UserDao {
    ...
    public static final String COLUMN_NAME_ID = "username";//用户id
    ...
    public void saveContactList(List<User> contactList) {
        ...
        if (db.isOpen()) {
            ...
            for (User user : contactList) {
                ...
                if (user.getRecent() != 0L) {
                    values.put(COLUMN_NAME_RECENT, user.getRecent());
                }
    ...
    public Map<String, User> getContactList() {
        ...
        if (db.isOpen()) {
            ...
            while (cursor.moveToNext()) {
                ...
                int recent = cursor.getInt(cursor.getColumnIndex(COLUMN_NAME_RECENT));
                User user = new User();
